...
| Osadebe | Captain of Eze Amadi's personal service, permanently assigned to Idoro | Alive. The crown's primary eyewitness and liaison to Idoro. Leads the Ijeoma search party (himself, Emenike, Ifeanyi, Okonjo), sketching fresh maps each evening past the edge of Ubani's survey. Read unexplained torchlight (Ijeoma's escape attempt) as an opening and split the party to scout the wall directly, costing Ifeanyi a serious wound (Ep127). Current thread: on hearing the compound's alarm bell (Mfoniso and Ebiere's duel, unknown cause to the party), left Ifeanyi guarding camp and led Emenike and Okonjo over the now emptied northern wall, colliding with the fight itself and cutting through Emenike's instinctive recognition of Mfoniso as the Idoro attacker to keep the group moving before guards converge (Ep129). |
...
| Ebiere | Trading House field agent who orchestrated the boundary ambush | Alive. **Reveal (Ep125):** never actually cut loose — quietly reassigned to a small downriver holding two seasons ago while publicly disowned as a rogue agent, kept in reserve for exactly the kind of task the House could not afford to be seen requesting directly. Current thread: engaged Mfoniso in open combat in the compound's corridor after Mfoniso blocked the guarded door (Ep128); the fight triggered a compound wide alarm that pulled guards inward, emptying the outer wall long enough for the search party to breach it and collide with the duel itself (Ep129). Genuinely did not want the fight; offered Mfoniso a way to step aside before pressing the attack. |
...
### 5.2 WHO KNOWS WHAT — dramatic irony ledger (as of Episode 129)
