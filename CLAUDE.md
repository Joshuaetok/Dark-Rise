...
| Osadebe | Captain of Eze Amadi's personal service, permanently assigned to Idoro | Alive. The crown's primary eyewitness and liaison to Idoro. Leads the Ijeoma search party (himself, Emenike, Ifeanyi, Okonjo), sketching fresh maps each evening past the edge of Ubani's survey. Current thread: read unexplained torchlight inside the compound (Ijeoma's escape attempt, unknown to the party) as an opening and split the party into two pairs to scout the wall directly for the first time; bound Ifeanyi's serious rib wound himself after a hasty new patrol clash, and now carries the added burden of a wounded man slowing every future choice (Ep127). |
...
| Okonjo | Soldier, Chidebe's garrison at Idoro | Alive, with the search party. Found the toppled spiral boundary stone an hour before dusk on the fourth day west (Ep101). Current thread: killed one attacker and helped Ifeanyi break contact after the northern wall patrol clash, hauling him clear before the alarm could spread further; pressed Osadebe beforehand to fix a clear line for how close scouting could safely go (Ep127). |
