...
| Okonjo | Soldier, Chidebe's garrison at Idoro | Alive, with the search party. Found the toppled spiral boundary stone an hour before dusk on the fourth day west (Ep101). Killed one attacker and helped Ifeanyi break contact after the Ep127 northern wall clash. Current thread: crossed the wall's gap with the group while Mfoniso held it alone, then moved on into unfamiliar dark ground on the far side, still favoring his tender ankle (Ep132). |
...
### 5.2 WHO KNOWS WHAT — dramatic irony ledger (as of Episode 132)
...
| Mfoniso and the Warden fought each other directly at the wall gap, the closest fight of either woman's career; both drew blood before a second wave of guards forced Mfoniso to break off and flee alone into unfamiliar ground, wounded and uncertain whether the rest of the group is still within reach ahead of her (Ep132) | The Warden, her guards at the gap, and Mfoniso | Osadebe, Emenike, Ijeoma, and Okonjo, already across the gap and moving on, have no idea whether Mfoniso is alive, free, or still being pursued |
...
- **Episode 132 — "What Ten Years Finally Cost" (2026-11-16):** Mfoniso
  refuses to cross the wall's gap with the others, staying behind
  alone to buy them time. The Warden's guards reach her first and she
  holds the narrow ground, but the Warden herself steps into the
  torchlight next, drawing a blade against Mfoniso directly for the
  first time either of them can remember, ten years of shared training
  turned against itself in the closest, most personal fight of
  Mfoniso's career. Both women draw blood and neither can press the
  advantage before a second wave of guards arrives; Mfoniso breaks off
  and flees wounded into unfamiliar dark ground, the Warden's parting
  words making clear the debt between them is not finished. Closes on
  Mfoniso running blind, uncertain whether the rest of the group is
  still within reach ahead of her.
