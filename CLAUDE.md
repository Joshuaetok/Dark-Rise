...
|---|---|---|
| Amara | Mother of the twins | Alive, Idoro, full council seat. Knows the entity, the presence, Chibundu's identity, and Elder Maka's condition — no secrets left within the household. Current thread: broke the bridge between Zara and Adaugo by force the instant the anchor thread reacted (Ep82); has sealed the compound under a doubled watch for the night rather than attempt another reading or severing before dawn. |
| Obi | Father of the twins | Alive, Idoro. Fully present and active partner to Amara in every crisis since Episode 6. Current thread: steadied Zara through the aftermath of the severed reading (Ep82) while Amara held Adaugo, both girls shaking in a circle none of them chose to stand inside. |
| Zara | Village midwife | Alive, living mostly at Amara's compound. Delivered both twins; carries a dormant blood thread the presence (not the entity) has used to reach her since her Episode 42 return. Her borrowed sense of danger has been the family's best early warning system since Episode 69. Current thread: survived the presence tearing itself back out of her (Ep82), shaken but intact; told Adaugo plainly, for the first time, that she considers her family — the first time either has said the word between them. |
| Adaugo | Elder Maka's surviving daughter | Alive, Idoro, still carrying an active foreign working. Fully reconciled with her mother since Episode 66; learning the old rites. Current thread: sleeping between Amara and Elder Maka under full guard (Ep82) while the anchor thread on her wrist remains uncut, too dangerous to touch again before dawn; racked with guilt over what Zara nearly paid on her behalf. |
| Elder Maka | Elder priestess | Alive, Idoro, restored to a respected advisory council seat (not sole authority over the old law, stripped Ep19). Secretly carries her own thin thread to the entity since the Episode 12 binding rite (now openly known to the household and village). Current thread: called off any further reading or severing attempt for the night (Ep82), judging the household unprepared to face a second reaction like the one that nearly happened; has Adaugo sleeping beside her under guard. |
...
| Osadebe | Captain of Eze Amadi's personal service, permanently assigned to Idoro | Alive. The crown's primary eyewitness and liaison to Idoro. Recently returned from a full moon in Udo (Ep73), openly frustrated at how slow crown caution is. Current thread: refused rest and took up the gate watch himself overnight (Ep82), unwilling to lose the compound on the same evening he already lost Mfoniso's trail once. |
| Chidebe | Captain, commands the crown garrison at Idoro | Alive. Disciplined, trusted by Osadebe. Has doubled the night watch three times in episodes 77-78 as warnings escalate. Current thread: walked the compound wall repeatedly overnight (Ep82), holding the household's heaviest watch yet after the anchor thread's discovery. |
...
| *(unnamed entity)* | Ancient presence beneath Oso, bonded to Chibundu | Active. Three centuries old, patient and transactional; taught Chibundu control and restraint over many episodes. Current thread: reached toward the presence unprompted for the first time in their acquaintance (Ep82) after it tore itself free of Zara, recognizing it was hurt; told Chibundu that a hunting tradition passed down across generations is a far harder danger to outthink than a single skilled hunter. |
| *(unnamed presence)* | Older power beyond Oso's outer borders, reaches Chibundu through dreams and has spoken through Zara | Active. Named Chibundu (Ep47). Once lost a guardian ground centuries ago to a hunter using the exact tactic Mfoniso now uses (take the people the guardian loves, wait, strike slowly) — revealed Ep67. Broke its three century habit of never overspending its strength to save Kene directly (Ep70), at a cost it still hadn't finished paying as of Ep72-73. Current thread: tore itself out of Zara to disengage when Adaugo's working reacted to being read (Ep82), further spending strength it hadn't recovered; recognized the working's craft as the exact technique used by the hunter who took its guardian ground three centuries ago, meaning Mfoniso inherited her method rather than invented it. |
...
| Mfoniso | Ijoma Concern's retained guardian hunter | Active — the story's current antagonist. Failed to abduct Kene (Ep70) when the presence intervened directly; pivoted to a slow, undetectable working against Zara's borrowed senses instead, confirmed succeeding by Ep77-78. Current thread: felt the presence reach back along Adaugo's anchor thread for the first time in her career (Ep82), an experience her own teacher once warned meant facing a guardian old enough to remember being hunted before; decided to abandon her original patient timeline and move against the family sooner than planned. Confirmed as trained in or descended from the same hunting lineage that took the presence's guardian ground three centuries ago. True face and full backstory not yet revealed. |
