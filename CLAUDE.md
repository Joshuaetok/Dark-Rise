...
|---|---|---|
| Amara | Mother of the twins | Alive, Idoro, full council seat. Knows the entity, the presence, Chibundu's identity, and Elder Maka's condition — no secrets left within the household. Current thread: running for the third bend in the river (Ep79) with Obi after learning Adaugo unknowingly gave Mfoniso her exact routine and is already alone on the path. |
| Obi | Father of the twins | Alive, Idoro. Fully present and active partner to Amara in every crisis since Episode 6. Current thread: running beside Amara for the third bend (Ep79), racing to reach Adaugo before Mfoniso does. |
| Zara | Village midwife | Alive, living mostly at Amara's compound. Delivered both twins; carries a dormant blood thread the presence (not the entity) has used to reach her since her Episode 42 return. Her borrowed sense of danger has been the family's best early warning system since Episode 69. Current thread: reached for Adaugo through her damaged senses (Ep79) and felt only muffled nothing, then ran for Elder Maka's compound on instinct alone when Adaugo missed their evening visit. |
| Adaugo | Elder Maka's surviving daughter | Alive, Idoro — in immediate danger. Fully reconciled with her mother since Episode 66; learning the old rites. Current thread: cornered alone by Mfoniso at the third bend in the river (Ep79), who has not yet decided what she needs from her and is waiting to see who comes running and what they'll trade. |
| Elder Maka | Elder priestess | Alive, Idoro, restored to a respected advisory council seat (not sole authority over the old law, stripped Ep19). Secretly carries her own thin thread to the entity since the Episode 12 binding rite (now openly known to the household and village). Current thread: realized from Adaugo's offhand account of a questioning "traveler" (Ep79) that Mfoniso now has Adaugo's exact routine, hour, and path, and raised the alarm at Amara's compound — too late to stop Adaugo from already walking to Zara's alone. |
...
| Osadebe | Captain of Eze Amadi's personal service, permanently assigned to Idoro | Alive. The crown's primary eyewitness and liaison to Idoro. Recently returned from a full moon in Udo (Ep73), openly frustrated at how slow crown caution is. Current thread: took the fastest horse in the garrison and is riding hard for the third bend (Ep79), aiming to reach Adaugo well ahead of any soldier on foot. |
| Chidebe | Captain, commands the crown garrison at Idoro | Alive. Disciplined, trusted by Osadebe. Has doubled the night watch three times in episodes 77-78 as warnings escalate. Current thread: realized (Ep79) the garrison guarded the boundary and tree line but never the ordinary river path, and redirected soldiers there the moment Adaugo's danger became clear. |
...
| *(unnamed entity)* | Ancient presence beneath Oso, bonded to Chibundu | Active. Three centuries old, patient and transactional; taught Chibundu control and restraint over many episodes. Current thread: felt Idoro's ambient dread spike sharply (Ep79) but, cut off by distance exactly as it was the night it could not reach Kene in time, can tell Chibundu only that danger close to Zara is moving faster than anyone can outrun. Maintains a wary, still-not-fully-trusting relationship with the presence, the second old power that also claims Chibundu. |
...
| Mfoniso | Ijoma Concern's retained guardian hunter | Active — the story's current antagonist. Failed to abduct Kene (Ep70) when the presence intervened directly; pivoted to a slow, undetectable working against Zara's borrowed senses instead, confirmed succeeding by Ep77-78. Current thread: confronted Adaugo alone at the third bend in the river (Ep79) using the exact routine Adaugo gave up at the grinding stone; has not yet decided what she needs from her and is watching to see who comes running, and what they'll trade. True method and backstory not yet fully revealed. |
