...
|---|---|---|
| Amara | Mother of the twins | Alive, Idoro, full council seat. Knows the entity, the presence, Chibundu's identity, and Elder Maka's condition — no secrets left within the household. Current thread: caught herself watching trusted soldiers with new suspicion and admitted the shame of it to Obi; Elder Maka warned her the household must find the truth quickly before doubt does damage a rescue cannot mend (Ep85). |
...
| Osadebe | Captain of Eze Amadi's personal service, permanently assigned to Idoro | Alive. The crown's primary eyewitness and liaison to Idoro. Recently returned from a full moon in Udo (Ep73), openly frustrated at how slow crown caution is. Current thread: agreed with Chidebe that suspicion alone proves nothing after their shortlist narrowed to six names, one — the soldier Emenike — present at every compromised route change; proposed testing the shortlist with deliberately false details rather than confronting anyone directly (Ep85). |
| Chidebe | Captain, commands the crown garrison at Idoro | Alive. Disciplined, trusted by Osadebe. Has doubled the night watch three times in episodes 77-78 as warnings escalate. Current thread: cross referenced duty rosters and narrowed a shortlist of six names, with the long trusted soldier Emenike present at every compromised change; broke up a fight between two soldiers born of unproven suspicion and barred further accusations without proof brought to him or Osadebe first (Ep85). |
...
| Emenike | Soldier in Chidebe's garrison at Idoro | Alive. Served under Chidebe since before the boundary ambush (Ep51); known as steady and dependable, first to volunteer for the coldest watches. Current thread: the only name present at every one of the three compromised route changes on Chidebe and Osadebe's shortlist of six; not yet confronted, about to be tested with deliberately false patrol details rather than accused outright (Ep85). |
