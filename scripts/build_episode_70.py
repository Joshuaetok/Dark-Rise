...
EPISODE_CONTENT = [
    ...
    {"type": "body", "text": (
        "The entity's ledger marked what it watched, flat words over "
        "something near disbelief."
    )},
    {"type": "system", "text": "Presence extending beyond claimed ground. Range unprecedented. Cost unknown. Intervention proceeding regardless."},
    {"type": "body", "text": (
