...
EPISODE_CONTENT = [
    ...
    {"type": "scene_break", "text": ""},
    {"type": "body", "text": (
        "The ledger voice spoke over it all, flat against the rushing "
        "dark."
    )},
    {"type": "system", "text": "Vessel: unmediated contact event in progress. Presence addressing entity directly through third party host. Naming action imminent. Entity unable to intervene without risking harm to host."},
    {"type": "body", "text": (
