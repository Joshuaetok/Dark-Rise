...
EPISODE_CONTENT = [
    ...
    {"type": "scene_break", "text": ""},
    {"type": "body", "text": (
        "In Oso, the cold voice recorded what it saw building."
    )},
    {"type": "system", "text": "Vessel: presence appears to be preparing an unmediated contact event analogous to entity's own prior boundary disclosure. Timing relative to scholar's request unknown. Risk of simultaneous convergence: uncalculated."},
    {"type": "body", "text": (
