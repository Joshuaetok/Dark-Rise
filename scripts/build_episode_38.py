...
EPISODE_CONTENT = [
    ...
    {"type": "scene_break", "text": ""},
    {"type": "body", "text": (
        "The ledger voice recorded the defiance, flat, without anger."
    )},
    {"type": "system", "text": "Vessel: first direct verbal defiance of explicit instruction. Reasoning sound, not impulsive. Unable to counter without invoking authority alone."},
    {"type": "body", "text": (
