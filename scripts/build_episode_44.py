...
EPISODE_CONTENT = [
    ...
    {"type": "body", "text": (
        "In Oso, the ledger voice measured the boy against every page "
        "before him."
    )},
    {"type": "system", "text": "Vessel: rate of skill acquisition exceeds all prior developmental benchmarks by a wide margin. Hypothesis: capability was already present and fully formed prior to first deliberate attempt."},
    {"type": "body", "text": (
