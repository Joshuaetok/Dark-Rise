...
EPISODE_CONTENT = [
    ...
    {"type": "body", "text": (
        "The survey packed to leave within two days, its work genuinely "
        "finished now by its own leader's honest accounting, and Amara "
        "found herself, watching them go, grateful for an outcome she "
        "had not been at all certain the household could still reach by "
        "the time Ubani first crossed the tree line. \"We kept the "
        "secret,\" she told Elder Maka quietly, \"by giving away the "
        "truth we could afford to lose.\" Elder Maka nodded once. \"That "
        "is usually how the oldest secrets survive the longest,\" she "
        "said. \"Not by hiding behind nothing. By hiding behind "
        "something true enough that no one thinks to dig past it.\" "
        "Amara let that settle, watching the dust of the departing "
        "carts hang golden over the road."
    )},
    {"type": "body", "text": (
