...
EPISODE_CONTENT = [
    ...
    {"type": "body", "text": (
        "Beneath it, faint and flat, the entity's ledger voice kept its "
        "count."
    )},
    {"type": "system", "text": "Presence contact active. Communication register shifting from single sounds toward sustained meaning. Vessel comprehension stable."},
    {"type": "body", "text": (
