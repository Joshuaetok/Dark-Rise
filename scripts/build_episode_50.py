...
EPISODE_CONTENT = [
    ...
    {"type": "body", "text": (
        "The ledger voice cut through the moment, cold and immediate."
    )},
    {"type": "system", "text": "Vessel: hostile party approaching through the deliberately unguarded boundary section. Timing consistent with deliberate exploitation of reunion arrangements. Both maternal figure and vessel present and exposed. Response window: seconds."},
    {"type": "body", "text": (
