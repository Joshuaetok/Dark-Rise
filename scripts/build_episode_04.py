...
EPISODE_CONTENT = [
    ...
    {"type": "body", "text": (
        "In Oso, the flat cold voice took stock of what it could now "
        "reach."
    )},
    ...
    {"type": "body", "text": (
        "\"Amara,\" the doubled voice said, naming her the way an owner "
        "names a debt."
    )},
    {"type": "body", "text": (
    ...
    # System alert block
    {"type": "body", "text": (
        "The voice beneath the roots recorded it, flat and exact."
    )},
