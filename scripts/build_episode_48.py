...
EPISODE_CONTENT = [
    ...
    {"type": "body", "text": (
        "Word of what had happened at the boundary moved through Idoro "
        "in careful, incomplete fragments over the following days, "
        "shaped less by what Amara and Zara actually said than by what "
        "the rest of the village imagined must have happened to leave "
        "both women so visibly, unmistakably shaken. Ozoemena, hauling "
        ...
        "does,\" he asked her plainly, \"or only a mother's blood.\" Amara "
        "found she did not yet have an honest answer ready, only the "
        "certainty that the question itself no longer felt like the "
        "wrong one to ask. She carried it with her the rest of the day, "
        "the way a person carries a stone picked up without quite "
        "deciding to keep it."
    )},
    {"type": "body", "text": (
    ...
    {"type": "body", "text": (
        "Beneath the roots, the cold voice conceded the arithmetic."
    )},
    {"type": "system", "text": "Vessel: direct, unprompted request for physical reunion with maternal figure. Prior refusals based on risk assessment now partially obsolete. Full refusal no longer defensible on grounds previously used."},
    {"type": "body", "text": (
