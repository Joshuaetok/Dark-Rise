...
EPISODE_CONTENT = [
    ...
    {"type": "body", "text": (
        "The ledger voice marked the intrusion, flat and unhurried."
    )},
    {"type": "system", "text": "Vessel: third party access detected on previously abandoned thread. Entity did not initiate. Origin consistent with presence contacted during parlay. Purpose unknown."},
    {"type": "body", "text": (
