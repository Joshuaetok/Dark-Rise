...
EPISODE_CONTENT = [
    ...
    {"type": "body", "text": (
        "Beneath Oso, the voice weighed the new risk, flat and unhurried."
    )},
    ...
    {"type": "body", "text": (
        "\"Obi. And Amara,\" Zara said."
    )},
    {"type": "body", "text": (
        "\"And how long have they known.\" Elder Maka's voice stayed "
        "level, which was worse than anger."
    )},
    {"type": "body", "text": (
        "\"Since that same night,\" Zara admitted."
    )},
    {"type": "body", "text": (
