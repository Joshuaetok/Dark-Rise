...
EPISODE_CONTENT = [
    ...
    {"type": "body", "text": (
        "In Oso, the cold voice struck a line through its oldest "
        "assumption."
    )},
    {"type": "system", "text": "Vessel: existence of a second, preexisting claim confirmed by direct contact. Nature, origin, and intent of second claim unknown. Entity's assumed exclusivity over vessel invalidated."},
    {"type": "body", "text": (
